          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap", justifyContent: "center" }}>
              ...
              <div
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "rgba(255, 255, 255, 0.1)";
                  e.currentTarget.style.borderColor = "rgba(0, 206, 201, 0.5)";
                  e.currentTarget.style.boxShadow = "0 4px 20px rgba(0, 206, 201, 0.25)";
                  e.currentTarget.style.transform = "translateY(-2px)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = "rgba(255, 255, 255, 0.05)";
              ...
              >
                <span style={{ display: "inline-block", transform: "scale(1.1)", marginRight: 2 }}>⚡</span>
                <span>Het Parekh</span>
              </div>
            </div>
          </div>
        </div>
